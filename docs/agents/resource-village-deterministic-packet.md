...
| ----------------------------------- | ----------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- | -------------------------- | ----------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| Terrain: Pipoya tilesets            | https://pipoya.itch.io/pipoya-rpg-tileset-32x32-pixel | Free commercial + non-commercial; raw asset redistribution prohibited. Verify license text at source before final submission. | 32x32, scale 1             | Grass, dirt, water, flowers, walls; `[Base]BaseChip` floors/walls | `apps/game/src/tiled/[A]Grass_pipo.png`, `[A]Dirt_pipo.png`, `[A]Water_pipo.png`, `[A]Flower_pipo.png`, `[A]Wall-Up_pipo.png`, `[Base]BaseChip_pipo3.png` | in-repo          |
...
`apps/game/src/modules/main/questLoop.ts` implements the old 3-shard quest. It is **replaced**, not extended, by `resourceLoop/` + `orders/` under #16/#17. Its test (`questLoop.test.ts`) is removed with the legacy quest, not patched onto.
