...
// Instead, `buildVillageEventsFromTmx()` parses apps/game/src/tiled/village.tmx
// at module-load (via @canvasengine/tiled) and returns the static `events`
// array; RPG-JS creates each entry through `map.createDynamicEvent` during
// updateMap - the same mechanism the legacy simplemap module used. The runtime
...
import { VILLAGE_EVENTS } from "./map-adapter";
